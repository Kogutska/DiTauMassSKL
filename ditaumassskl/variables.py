...
HH_VARIABLES_TRUTH={
   ...
   'true_ditau_vis_dphi': {
    ...
    'true_ditau_vis_dpt': {
        'title': r'$\Delta PT(\tau,\tau)$',
        'root': '#font[152]{#Delta P_{T}}(#font[152]{#tau},#font[152]{#tau})',
        'filename': 'ditau_dpt',
        'binning': (6, 0., 2.4),
        'legend': 'left',
        },
...
HH_VARIABLES = {
    ...
    'ditau_vect_sum_pt': {
        'title': r'$\sum \vec{p_{T}}$ ',#Taus and Two Leading Jets',
        'root': '#font[152]{#sum} #font[52]{p}_{T} #font[52]{Taus and Two Leading Jets}',
        'filename': 'ditau_vect_sum_pt',
        'binning': (20, 50, 550),
        'units': 'GeV',
    ...
    'ditau_scal_sum_pt': {
        'title': r'$\sum p_{T}$ ',#Taus and All Selected Jets',
        'root': '#font[152]{#sum} #font[52]{p}_{T} #font[52]{Taus and All Selected Jets}',
        'filename': 'ditau_scal_sum_pt',
        'binning': (20, 50, 550),
        'units': 'GeV',
    ...
    'ditau_mt_lep1_met': {
        'title': r'$m_{T}(\tau_{2} MET)$',
        'root': '#font[52]{m}_{T} (l, #font[52]{E}^{miss}_{T})',
        'filename': 'ditau_mt_lep1_met',
        'binning': (20, 0, 100),
        'units': 'GeV',
    },
   ...
   'ditau_cosalpha': {
    ...
    'ditau_met_lep0_cos_dphi': {
        'title': r'$\cos[\Delta\Phi(MET,\tau1)]$',
        'root': '#font[52]{cos}(#font[152]{#alpha}_{#font[152]{#tau}#font[152]{#tau}})',
        'filename': 'ditau_met_lep0_cos_dphi',
        'binning': (12, -1.2, 1.2),
        },
    'ditau_met_lep1_cos_dphi': {
        'title': r'$\cos[\Delta\Phi(MET,\tau2)]$',
        'root': '#font[52]{cos}(#font[152]{#alpha}_{#font[152]{#tau}#font[152]{#tau}})',
        'filename': 'ditau_met_lep1_cos_dphi',
        'binning': (12, -1.2, 1.2),
        },
